<?php include('partials-front/menu.php'); ?>
    ...
    <section class="food-search text-center">
        <div>
            ...
            <h2>Tolet In <a href="#" class="text-white">"<?php echo $category_title; ?>"</a></h2>
                            ...
                            <div class="food-menu-box">
                                <div class="food-menu-img">
                                    <?php 
                                        ...
                                        {
                                            ?>
                                               <img src="<?php echo SITEURL; ?>images/house/<?php echo $image_name; ?>" alt="Image Not Display" class="img-responsive img-curve"> 
                                            <?php
                                        }
